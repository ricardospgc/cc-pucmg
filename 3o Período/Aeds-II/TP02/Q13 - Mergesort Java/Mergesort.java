...
class Registro {
    ...
    public void printListAttribute(){
        characterList.forEach(n -> { MyIO.println(n.getName() + ": " + n.getActorName()) ;});
    }// printListAttribute()
...
public class Mergesort{
    ...
    public static int cmpCharacter(Character a, Character b){
        int cmp = a.getActorName().compareTo(b.getActorName());
        numComparacoes++;
    ...
    */
    private static void mergesort(ArrayList<Character> list, int esq, int dir) {
        if (esq < dir){
            int meio = (esq + dir) / 2;
            mergesort(list, esq, meio);
            mergesort(list, meio + 1, dir);
            intercalar(list, esq, meio, dir);
        }
    }// mergesort()
    ...
    * @param int dir fim do array a ser ordenado
    */ 
    public static void intercalar(ArrayList<Character> list, int esq, int meio, int dir){
        int n1, n2, i, j, k;
        n1 = meio - esq + 1;
        n2 = dir - meio;
        Character[] a1 = new Character[n1];
        Character[] a2 = new Character[n2];
        ...
        while(i<n1) list.set(k++,a1[i++]);
        while(j<n2) list.set(k++, a2[j++]);
    }// intercalar()
    ...
    public static void sort(Registro registro){
        ...
        mergesort(registro.characterList, 0, registro.characterList.size()-1);
