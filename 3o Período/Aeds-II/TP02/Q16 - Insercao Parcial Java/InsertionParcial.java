...
public class InsertionParcial{
    public static int numComparacoes = 0;
    public static int numMovimentacoes = 0;

    public static float time = 0;

    public static String logFileName = "803833_insercaoParcial.txt";
     ...
     */
    public static void insertionParcial(ArrayList<Character> list, int k){
        for (int i = 1; i < Math.min(k, list.size()); i++) {
    ...
    public static void sort(Registro registro, int k){
        ...
        insertionParcial(registro.characterList, registro.characterList.size());
