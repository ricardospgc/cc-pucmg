...
public class ListaSeq {
    ...
    private Character[] lista; // array com os elementos
     ...
     */
    public void inserirInicio(Character newCharacter) throws Exception{
        // Verifica se e' possivel inserir
        if(size >= lista.length) throw new Exception("Erro ao inserir! Lista cheia!");
     ...
     * @throws Exception Se a lista estiver cheia
     */
    public void inserirFim(Character newCharacter) throws Exception{
        // Verifica se e' possivel inserir
        if(size >= lista.length) throw new Exception("Erro ao inserir! Lista cheia!");

        lista[size] = newCharacter;
        size++;
    }// fim inserirFim()
     ...
     */
    public void inserirPos(Character newCharacter, int pos) throws Exception{
        // Verifica se e' possivel inserir
        if(size >= lista.length) throw new Exception("Erro ao inserir! Lista cheia!");
        if(pos > size || pos < 0) throw new Exception("Erro ao inserir! Posicao inválida");
    ...
    public Character removerInicio() throws Exception{
        ...
        if(size == 0) throw new Exception("Erro ao remover! Lista vazia!");

        Character removido = lista[0];
        size--;
     ...
     */
    public Character removerPos(int pos) throws Exception{
        // Verifica se e' possivel inserir
        if(size == 0) throw new Exception("Erro ao remover! Lista vazia!");
        if(pos >= size || pos < 0) throw new Exception("Erro ao remover! Posicao inválida");

        Character removido = lista[pos];
        size--;
        ...
        try{
            switch (input[0]) {
                ...
                case "IF":
                    ...
                    break;
                case "I*":
                    c = getCharacter(input[2]);
                    inserirPos(c, Integer.parseInt(input[1]));
                    break;
                case "RI":
                    c = removerInicio();
                ...
                case "RF":
                    ...
                    break;
                case "R*":
                    c = removerPos(Integer.parseInt(input[1]));
                    MyIO.println("(R) " + c.getName());
                    break;
                default:
