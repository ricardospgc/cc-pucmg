...
class CelulaDupla {
    ...
    CelulaDupla(Character elemento){
...
class ListaDupla {
    public CelulaDupla primeiro; // Celula cabeca, sempre vazia, o prox aponta para o primeiro
    public CelulaDupla ultimo; // Indica o fim da estrutura, aponta para o ultimo
    public int size; // Quantidade de elementos na lista
    ...
    public void inserir(Character newCharacter) throws Exception{
        ultimo.prox = new CelulaDupla(newCharacter); // novo elemento apos o antigo ultimo
        ultimo.prox.ant = ultimo; // conecta o ant do novo
...
public class Quicksort{
    ...
    public static String logFileName = "803833_quicksort2.txt";
     ...
     * @param b
     */
    public static void swap(ListaDupla lista, CelulaDupla a, CelulaDupla b){
        Character aux = a.elemento;
    ...
    public static int cmpCharacter(Character a, Character b){
        int cmp = a.getHouse().compareTo(b.getHouse());
        numComparacoes++;

        // desempata por nome caso House seja igual
        if(cmp == 0){
    ...
    private static boolean isLessOrEqualTo(CelulaDupla i, CelulaDupla j){
        boolean resp = false;
     ...
     * @param dir
     */
    private static void quicksort(ListaDupla lista, CelulaDupla esq, CelulaDupla dir) {
        if(esq != dir && esq != dir.prox){
            ...
            while (isLessOrEqualTo(i, j)) {
                while (cmpCharacter(i.elemento, pivo.elemento) < 0) i = i.prox;
                while (cmpCharacter(j.elemento, pivo.elemento) > 0) j = j.ant;
    ...
    public static void main(String[] args){
        ...
        ListaDupla lista = new ListaDupla(); // 0 = linux / 1 = Windows / void = VERDE

        try{
            // Leitura e armazenamento de personagens
            String id = scn.nextLine();
            while(!isFim(id)){
                Character newCharacter = lista.getCharacter(id);
