...
public class ListaFlex {
    ...
    public void inserirFim(Character newCharacter) throws Exception{
        ultimo.prox = new Celula(newCharacter); // novo elemento apos o antigo ultimo
    ...
    public void inserirPos(Character newCharacter, int pos) throws Exception{
        if(pos < 0 || pos > size){
            ...
            inserirInicio(newCharacter);
        } else if (pos == size){
            inserirFim(newCharacter);
        } else {
    ...
    public Character removerFim() throws Exception{
        if(primeiro == ultimo) 
            throw new Exception("Erro ao remover no fim, Lista vazia!");

        Celula i; // ponteiro de contagem
        // caminha ate a penultima posicao
        for(i = primeiro; i.prox != ultimo; i = i.prox);

        Character removido = ultimo.elemento;
    ...
    public Character removerPos(int pos) throws Exception{
        ...
        if (primeiro == ultimo)
            ...
            i = tmp = null; // desconecta o ponteiro de contagem e o tmp
        }
    ...
    static public void main(String[] args){
        ...
        ListaFlex lista = new ListaFlex(); // 0 = linux / 1 = Windows / void = VERDE
