...
* Matricula: 803833
* Trabalho Prático 4 - Aeds II - Q08
*/
...
class Hash { // Organizada baseada no nome do Jogador
    ...
    public int hashAltura(Jogador jogador){
        return jogador.getAltura() % tam;
    }//fim hashAltura()

    public int rehashAltura(Jogador jogador){
        return (jogador.getAltura() + 1) % tam;
    }//fim hashAltura()
    ...
    private boolean pesquisa(String chave){
        ...
        for(int i = 0; i < tam && resp == false; i++){
    ...
    public void criaLog(){
        ...
        String fileName = "hashRehash.txt";
